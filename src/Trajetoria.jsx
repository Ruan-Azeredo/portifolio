            ...
            <Title title='Trajetoria' grayscale={true}/>
                <div className="time-line">
                    ...
                    <div className="date-container date-r">
                        ...
                        <CardComponent name='Adapti' logo='logo-adapti.png' description='Entrei na Empresa Junior da Comnputação da Faculdade, empresa a qual não tem fins lucrativos para os membros, e que faço parte até hoje, nela aprendi como programar e ter a contato com o mundo do desenvolvimento web.'/>
                    </div>  
